...
<!-- Salut!! @Nico KraZhtest krazhtest@ya.ru -->
	...
	.links img {max-width:20px;margin:-3px 0}
	.news img {max-width:20px;margin:-3px 0}
  .news {font-size:0.6em}
	.links {font-size:0.6em}
	.link > p:nth-child {height:115px}
...
<select style="float:right;" onchange="if (this.value) window.location.href=window.location.href+this.value">
	...
	<h3>&#9873; Listen to the Shaarli Network (278 peoples), <a id="river"  href="http://shaarli-api.ecirtam.net/latest?format=rss">the river</a> or any RSS flux!</h3>
	...
	<a href="http://ponyhacks.com/"><img style="width:110%" src="http://shaarli-api.ecirtam.net/getfavicon?id=325">KraZhtest - Pony links - Fresh hacks - Cest le bordel</a>
